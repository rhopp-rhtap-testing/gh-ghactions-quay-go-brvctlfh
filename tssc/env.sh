...
export IMAGE_URL=${IMAGE_URL-quay.io/rhtap_qe/gh-ghactions-quay-go-brvctlfh:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhopp-rhtap-testing/gh-ghactions-quay-go-brvctlfh-gitops
